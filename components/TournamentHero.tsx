    ...
    <section className="mx-auto max-w-7xl px-6 py-24">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-10 shadow-2xl shadow-indigo-500/10">
        ...
        <h1 className="mb-6 max-w-3xl text-5xl font-black leading-tight md:text-7xl">
          Compete, register, and climb the leaderboard.
        </h1>

        <p className="max-w-2xl text-lg leading-8 text-gray-300">
          This page will be the main place for tournament announcements,
          available competitions, registration, brackets, and future Discord
          account login.
        </p>
