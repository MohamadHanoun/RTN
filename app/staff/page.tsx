        ...
        <section className="mx-auto grid max-w-[1680px] gap-8 px-6 py-10 lg:px-10 2xl:px-14">
          {staffMembers.length === 0 ? (
            ...
            <section className="overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] shadow-2xl shadow-black/20">
              <div className="hidden border-b border-white/10 bg-black/25 px-5 py-4 text-xs font-black uppercase tracking-[0.14em] text-gray-500 md:grid md:grid-cols-[90px_minmax(0,1fr)_minmax(0,1fr)_130px]">
                <span>Avatar</span>
                <span>Name</span>
                <span>Role</span>
                <span>Status</span>
